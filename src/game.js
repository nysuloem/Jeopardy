...
module.exports={FALLBACK_GAME,EMERGENCY_GAME,normalize,clueFingerprint,responseText,gameClueRecords,gameHasDuplicate,locallyCorrect,categoryRuleValid,beforeAfterValid,validateGame,generateGame,generateFinalClue,judge};
