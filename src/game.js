...
const EMERGENCY_GAME = {
  rounds: [
    {title:'JEOPARDY!',categories:[
      ...
      {name:'STARTS WITH S',clues:[clue('A person who studies stars and galaxies has this profession.','scientist'),clue('This word means a brief description of a longer work.','summary'),clue('It is the process by which a solid changes directly into a gas.','sublimation'),clue('This political right allows citizens to vote.','suffrage'),clue('From Greek for scattered, this term describes communities dispersed from a homeland.','diaspora')]},
...
module.exports={FALLBACK_GAME,EMERGENCY_GAME,normalize,clueFingerprint,gameClueRecords,gameHasDuplicate,locallyCorrect,validateGame,generateGame,judge};
